(*  OCaml Compatibility Library for F#
    ...
    This code is available under the GNU Lesser
...
let parse_string_conversion sfmt =
  let rec parse neg i =
    ...
    // TODO : Should this be Sformat.unsafe_get instead of String.get?
    // It was originally String.unsafe_get, but there's no documented function with that name.
...
let scan_format fmt args n pos cont_s cont_a cont_t cont_f cont_m =
  ...
  and scan_flags spec n widths i =
    ...
    | x when x >= '0' && x <= '9' -> scan_flags spec n widths (succ i)
